 ...
 * Description: This plugin allows create Rangeslider for contact form 7.
  * Version: 1.0
...
if (!defined('OCCF7RS_PLUGIN_NAME')) {
    define('OCCF7CRS_PLUGIN_NAME', 'Range Slider Contact Form 7');
}
     ...
     //Load all includes files
      ...
      function OCCF7RS_install_error() {
        ...
        function OCCF7RS_load_script_style() {
          ...
          wp_enqueue_script( 'OCCF7RS-jquery-ui-js', OCCF7RS_PLUGIN_DIR . '/includes/js/jquery-ui.js', false, '2.0.0' );
          wp_enqueue_style( 'OCCF7RS-jquery-ui-css', OCCF7RS_PLUGIN_DIR . '/includes/js/jquery-ui.css', false, '2.0.0' );
